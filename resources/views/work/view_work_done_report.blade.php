...
@section('content')
    ...
    <div class="row box_containner">
        ...
        <div class="table_container">
            <table id="row_data" class="table table-bordered dataTable table-striped data" cellspacing="0" width="100%">
                <thead>
                <tr class="bg-info">
                ...
                <tbody>
                {{--@foreach($district_data as $index=>$Main_obj)--}}
                    {{--<tr>--}}
                        {{--<td>{{$index}}</td>--}}
    ...
    <script>
        ...
        var Results = [
            ...
            [{{$index}},
                {{$Main_obj->districtid}},
                {{$Main_obj->school_code}},
                {{$Main_obj->schoolname}},
                {{$Main_obj->schooladdr}},
                {{$Main_obj->place}},
                {{$Main_obj->studentname}},
                {{$Main_obj->fathername}},
                {{$Main_obj->data_id}},
                {{$Main_obj->class_data}},
                {{$Main_obj->f1}},
